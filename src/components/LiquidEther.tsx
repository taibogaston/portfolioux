...
// Three.js r150+ usa constantes en el objeto; RGBAFormat puede ser 1023
const RGBAFormat = (THREE as { RGBAFormat?: number }).RGBAFormat ?? 1023;
...
export default function LiquidEther({
  ...
  resolution = 0.5,
  isBounce = false,
  colors = ["#f78abf", "#f59cc8", "#f7afd4", "#f8c2df"],
  style = {},
  className = "",
  autoDemo = true,
  autoSpeed = 0.5,
...
`;
    ...
    class Viscous extends ShaderPass {
      ...
      update(opts: { viscous: number; iterations: number; dt: number }) {
        ...
        for (let i = 0; i < opts.iterations; i++) {
          ...
          (this.props as { output: THREE.WebGLRenderTarget }).output = fbo_out;
          this.uniforms.dt.value = opts.dt;
          super.update();
        }
        return fbo_out;
    ...
    class Poisson extends ShaderPass {
      ...
      update(opts: { iterations: number }) {
        ...
        for (let i = 0; i < opts.iterations; i++) {
          ...
          (this.props as { output: THREE.WebGLRenderTarget }).output = p_out;
          super.update();
        }
        return p_out;
      }
    ...
    class Simulation {
      ...
      update() {
        ...
        this.pressure.update({ vel, pressure: pressure! });
      }
    }
